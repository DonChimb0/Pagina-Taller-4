    ...
    <div class="container">
        ...
        <form action="actualizar.php" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="intereses[]" value="Arte" id="interest2" <?php echo in_array('Arte', explode(',', $student['intereses'])) ? 'checked' : ''; ?>>
        ...
        <a href="ver_datos.php" class="btn btn-secondary">Volver a Datos Registrados</a>
    </div>
</body>
</html>